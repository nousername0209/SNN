...
from procgenenv import ProcgenModdedGym3Env, ENV_NAMES
from interactivelib import Interactive
from video_recorder import VideoRecorderWrapper
...
def make_interactive(vision, record_dir, **kwargs):
    ...
    env = ProcgenModdedGym3Env(num=1, **kwargs)
