...
class ProcgenModdedEnv(ModdedCEnv):
    """
    ...
    def __init__(
        ...
        super().__init__(
            ...
            options=options,
            c_func_defs=[
                "int get_state(void *, int, char *, int);",
                "void set_state(void *, int, char *, int);",
            ],
        )
    ...
    def modify(self, mod_name, mod_options):
        self._ffi.__dict__[f'mod_{mod_name}'](**mod_options)

class ProcgenModdedGym3Env(ProcgenModdedEnv):
    """
